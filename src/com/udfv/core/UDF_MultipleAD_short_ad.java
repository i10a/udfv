...
*/
public class UDF_MultipleAD_short_ad extends UDF_AD implements UDF_MultipleAD
{
    int my_times;
    int my_lbn;
    long my_length;
    ...
    /**
       ...
       @param name 名前
    */
    public UDF_MultipleAD_short_ad(UDF_Element elem, String prefix, String name){
	...
	debugMsg(3, "UDF_MultipleAD_short_ad#readFrom is not implemented... ignore");
	...
	UDF_AD ad = (UDF_AD)createElement("UDF_short_ad", null, null);
	ad.setDefaultValue();
	int start = my_lbn;
	long wsize = 0;
    ...
    */
	...
	return 16L * my_times;	//short_adのサイズは16
    }
    /**
       繰り返し数を求める。
    */
    public int getSize(){
	return 8 * my_times;	//short_adのサイズは16
    }
	...
	UDF_MultipleAD_short_ad elem = (UDF_MultipleAD_short_ad)super.duplicateElement();
	...
	System.err.println("UDF_MultipleAD_short_ad#getExtentPartRefNo is not implemented... ignore");
	return null;
    }
    public UDF_uint32 getExtentLbn(){
	System.err.println("UDF_MultipleAD_short_ad#getExtentLbn is not implemented... ignore");
	return null;
    }
    public UDF_uint32a getExtentLen(){
	System.err.println("UDF_MultipleAD_short_ad#getExtentLen is not implemented... ignore");
	return null;
    }
    public void setFlag(int flag){
	System.err.println("UDF_MultipleAD_short_ad#setFlag is not implemented... ignore");
    }
