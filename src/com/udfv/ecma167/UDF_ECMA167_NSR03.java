...
*/
public class UDF_ECMA167_NSR03 extends UDF_Element 
{
    ...
    */
	...
	@param name   エレメント名。
    */
    public UDF_ECMA167_NSR03(UDF_Element elem, String prefix, String name){
    ...
    */
	...
	UDF_ECMA167_NSR03 dup = new UDF_ECMA167_NSR03(this, null, getName());
	dup.setDefaultValue();
...
//begin:add your code here
	...
	if(structureType.getIntValue() != 0){
	    ...
	    el.addError(new UDF_Error
			(category, UDF_Error.L_ERROR, "Structure Type", "This field shall specify 0.",
			 "3/9.1.1", String.valueOf(structureType.getIntValue()), "0"));
	}
	
	// Standard Id は"NSR03"
	if(!standardId.getStringData().equals("NSR03")){
	    
	    el.addError(new UDF_Error
			(category, UDF_Error.L_ERROR, "Standard Identifier", "This field shall specify \"NSR03\".",
			 "3/9.1.2", standardId.getStringData(), "NSR03"));
	}
	...
	if(structureVersion.getIntValue() != 1){
	    ...
	    el.addError(new UDF_Error
			(category, UDF_Error.L_ERROR, "Structure Version",
			 "This field shall specify the version of the descriptor. The value 1 shall indicate the structure of Part 3.",
			 "3/9.1.3", String.valueOf(structureVersion.getIntValue()), "1"));
	}
	...
	if(reserved.getData()[0] != 0){
	    ...
	    el.addError(new UDF_Error
			(category, UDF_Error.L_ERROR, "Reserved",
			 ...
			 "3/9.1.4", String.valueOf(reserved.getData()[0]), "0"));
	}
