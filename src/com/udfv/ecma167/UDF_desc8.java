...
/**
Terminating&nbsp;Descriptor&nbsp;を表現するクラス。<br/>
...
<tr><td><b>Reserved</b></td><td><b>UDF_bytes</b></td><td><i>496</i></td></tr>
</table>
</dd>
</dl>
*/
public class UDF_desc8 extends UDF_CrcDesc implements UDF_VolDesc
{
    ...
    */
    public int getSize(){
	return 0+descTag.getSize()+reserved.getSize();
    }
    ...
    */
	...
	return (long)0+descTag.getSize()+reserved.getSize();
    }
    ...
    */
	...
	UDF_desc8 dup = new UDF_desc8(this, null, getName());
	dup.setDefaultValue();
...
//begin:add your code here
    public int getFixedTagId() { return 8; }
