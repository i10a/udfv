...
/**
Terminating&nbsp;Extended&nbsp;Area&nbsp;Descriptor&nbsp;を表現するクラス。<br/>
...
*/
public class UDF_ECMA167_TEA01 extends UDF_Element 
{
    ...
    */
	...
	@param name   エレメント名。
    */
    public UDF_ECMA167_TEA01(UDF_Element elem, String prefix, String name){
    ...
    */
	...
	UDF_ECMA167_TEA01 dup = new UDF_ECMA167_TEA01(this, null, getName());
	dup.setDefaultValue();
