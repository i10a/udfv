...
*/
public class UDF_desc265 extends com.udfv.udf201.UDF_desc265
{
    /**
      コンストラクタ
    ...
    */
    ...
    /**
      UDF 2.50規格ではこのdescriptorは使用しないので必ずエラーになります。
    */
	...
	el.addError(
            new UDF_Error(
                UDF_Error.C_UDF250, UDF_Error.L_ERROR, "Partition Integrity Entry",
