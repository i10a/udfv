...
<dl>
<dt>詳細</dt><dd>UDF_ECMA119PathTableとの違いは、データがビッグエンディアンで表現されているかどうかである。</dd>
<dt>フィールド一覧</dt>
<dd>
<table border="1">
...
<tr><td><b>LocOfExtent</b></td><td><b>UDF_uint32_be</b></td><td><i>locOfExtent.getSize()</i></td></tr>
<tr><td><b>ParentDirectoryNumber</b></td><td><b>UDF_uint16_be</b></td><td><i>parentDirectoryNumber.getSize()</i></td></tr>
...
*/
public class UDF_ECMA119PathTable_be extends UDF_Element 
{
    ...
    */
    public static String getUDFClassName( ) {
        return "UDF_ECMA119PathTable_be";
    }
	...
	@param name   エレメント名。
    */
    public UDF_ECMA119PathTable_be(UDF_Element elem, String prefix, String name){
    ...
    */
    public int getSize(){
	return 0+1+1+locOfExtent.getSize()+parentDirectoryNumber.getSize()+directoryId.getSize()+paddingField.getSize();
    }
    ...
    */
	...
	return (long)0+1+1+locOfExtent.getSize()+parentDirectoryNumber.getSize()+directoryId.getSize()+paddingField.getSize();
    }
    private UDF_uint8 lenOfDirectoryId;
    private UDF_uint8 extendedAttrRecordLen;
    private UDF_uint32_be locOfExtent;
    private UDF_uint16_be parentDirectoryNumber;
    ...
    */
    public UDF_uint32_be getLocOfExtent(){return locOfExtent;}
    /**
	parentDirectoryNumberを取得する。

	@return 取得したparentDirectoryNumber を返す。
    */
    public UDF_uint16_be getParentDirectoryNumber(){return parentDirectoryNumber;}
    /**
	directoryIdを取得する。
    ...
    */
	...
	@param	v 設定する値。
    */
    public void setLocOfExtent(UDF_uint32_be v){replaceChild(v, locOfExtent); locOfExtent = v;}
    /**
	parentDirectoryNumberを設定する。

	@param	v 設定する値。
    */
    public void setParentDirectoryNumber(UDF_uint16_be v){replaceChild(v, parentDirectoryNumber); parentDirectoryNumber = v;}
    /**
	directoryIdを設定する。
    ...
    */
	...
	locOfExtent = (UDF_uint32_be)createElement("UDF_uint32_be", "ecma119", "loc-of-extent");
	rsize += locOfExtent.readFrom(f);
	parentDirectoryNumber = (UDF_uint16_be)createElement("UDF_uint16_be", "ecma119", "parent-directory-number");
    ...
    */
	...
	UDF_ECMA119PathTable_be dup = new UDF_ECMA119PathTable_be(this, null, getName());
	dup.setDefaultValue();
	...
	dup.setLocOfExtent((UDF_uint32_be)locOfExtent.duplicateElement());
	dup.setParentDirectoryNumber((UDF_uint16_be)parentDirectoryNumber.duplicateElement());
